...
import { checkFace, fetchTimesheetPerson } from '../store/actions/aiface'
              ...
              >
                <View style={styles.centeredView}>
                  <View style={styles.modalView}>
                    ...
                    >{`Hi ${this.state.name} ! \nYou checked in successfully !`}</Text>
                    <Block row center space='between'>
                      <View>
                        <Image
                          ...
                          >
                            <Block style={{ flex: 0.7 }}>
                              ...
                              <Image
                                ...
                                source={{
                                  uri:
                                    // `https://edu.ailab.vn/api/employee/avatar?avatar_path=` +
                                    // avatar_path
                                    'data:image/png;base64,' + this.state.capturedImage

                                }}
                                // source={{ uri: `https://edu.ailab.vn/api/employee/avatar?avatar_path=uploads/employee/AI004/avatar/2023-02-02-10-40-12.png` }}
                              />
                            </Block>
                            <EButton
                              title='Back'
